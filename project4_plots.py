...
#renaming the column so that columns containing the data for both datasets have the same names
...
df.rename(columns={'goal_1_score' : 'no_poverty', #score for goal2:no poverty
                                       ...
                                       'goal_3_score':'health&wellbeing',#The score for Goal3: Good Health and Wellbeing.
                                       'goal_4_score':'quality_education', #The score for Goal 4: Quality Education.
                                       'goal_5_score':'gender_equality',#The score for Goal 5: Gender Equality
                                       ...
                                       'goal_8_score':'economic_growth',#The score for Goal 8: Decent Work and Economic Growth.
                                        'goal_9_score':'innovation&infrastructure', #The score for Goal 9: Industry, Innovation and Infrastructure
                                       'goal_10_score':'reduced_inequality', #The score for Goal 10: Reduced Inequalities.
                                       'goal_11_score':'sustainable_community', #The score for Goal 11: Sustainable Cities and Communitie
                                        'goal_12_score':'consumption&production', #The score for Goal 12: Responsible Consumption and Production.
                                       'goal_13_score':'climate_action', #The score for Goal 13: Climate Action.
                                       'goal_14_score':'life_under_water', #The score for Goal 14: Life Below Water.
                                       'goal_15_score':'life_on_land', #The score for Goal 15: Life on Land.     
...
#locating South AFrican entries
